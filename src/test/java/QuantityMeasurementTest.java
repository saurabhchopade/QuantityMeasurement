...
public class QuantityMeasurementTest {
    ...
    public void given1YardEqualTo36inch_ShouldReturnTrue() {
        Length length1 = new Length(1.0, Units.YARD);
        Length length2 = new Length(36.0, Units.INCH);
        boolean result = length1.compare(length2);
        Assert.assertTrue(result);
    }
    ...
    public void given36InchIfEqualTo1Yard_ShouldReturnTrue() {
        Length length1 = new Length(36.0, Units.INCH);
        Length length2 = new Length(1.0, Units.YARD);
        boolean result = length1.compare(length2);
        Assert.assertTrue(result);
    }
    ...
    public void given1YardIfEqualTo3Feet_ShouldReturnTrue() {
        Length length1 = new Length(1.0, Units.YARD);
        Length length2 = new Length(3.0, Units.FEET);
        boolean result = length1.compare(length2);
        Assert.assertTrue(result);
    }
}
